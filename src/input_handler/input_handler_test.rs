...
fn test_handle_json_null_input() {
    ...
    let (output, is_truthy) = handle_json(&program, &args, None, NO_SLURP, NO_SORT_KEYS).unwrap();
...
fn test_handle_json_with_json() {
    ...
    let (output, is_truthy) =
        handle_json(&program, &args, Some(json), NO_SLURP, NO_SORT_KEYS).unwrap();
...
fn test_handle_json_truthiness_zero() {
    ...
    let (_output, is_truthy) = handle_json(&program, &args, None, NO_SLURP, NO_SORT_KEYS).unwrap();
...
fn test_handle_json_invalid_json() {
    ...
    let result = handle_json(&program, &args, Some(json), NO_SLURP, NO_SORT_KEYS);
...
fn test_handle_json_missing_variable() {
    ...
    let result = handle_json(&program, &args, None, NO_SLURP, NO_SORT_KEYS);
...
fn test_handle_buffer_single_line() {
    ...
    let results = handle_buffer(&program, &args, reader, NO_SLURP, -1, NO_SORT_KEYS).unwrap();
...
"y": 20}"#;
    ...
    let results = handle_buffer(&program, &args, reader, true, -1, NO_SORT_KEYS).unwrap();
...
fn test_handle_input_null_input() {
    ...
    let results = handle_input(&program, &args, true, NO_SLURP, -1, NO_SORT_KEYS).unwrap();
